...
require_once 'allproductForm.php';
...
<body id="body">
    ...
    <main id="main" style="">
        ...
        <h2 class="HeaderDelivery">Товары</h2>
        ...
        <div class="container">
            ...
            <?php
            EnterProductAll($product_list, $category_list, $product_price_list, $production_list, $embroidery)
                ?>
